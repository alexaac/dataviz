...
class t {
  ...
  _listenCallback() {
    ...
    (t === this._listenValuePrev && Object(t) !== t) || this.updateDisplay(),
...
class d extends t {
  ...
  _initInput() {
    ...
    const t = (t) => {
      ...
      isNaN(e) ||
        (this._snapClampSetValue(e + t), (this.$input.value = this.getValue()));
    };
    this.$input.addEventListener('focus', () => {
      ...
      this.$input.addEventListener(
        ...
        (e) => {
          this._inputFocused &&
            (e.preventDefault(), t(this._normalizeMouseWheel(e) * this._step));
        },
        { passive: !1 }
      );
  }
